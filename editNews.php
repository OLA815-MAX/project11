...
if (isset($_POST['edit'])) {
	...
	$img=$_POST['image'];
	$cat=$_POST['category'];
	if(!empty($date)&&!empty($tit)&&!empty($con)&&!empty($auth)&&!empty($act)&&!empty($img)&&!empty($cat))
	{$query="UPDATE news SET news_date='$date',
		title='$tit',content='$con',author='$auth',
		status='$act',image='$img',category_id='$cat'
		where new_id='$id'";
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php $_PHP_SELF?>">
											  ...
											  <div class="col-md-6 col-sm-6 ">
												...
												<select class="form-control" name="category" id="">
												   ...
												   foreach ($data as$value) {echo
													...
													"<option value=cat1>{$value['name']}</option>";}?>

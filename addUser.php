...
if (isset($_POST['add'])) {
	...
	$act=$_POST['act'];
	$pwd=$_POST['password'];
	if(!empty($user)&&!empty($name)&&!empty($mail)&&!empty($act)&&!empty($pwd))
{$sql="INSERT INtO users(full_name,user_name,email,status,password)VALUES('$user','$name','$mail','$act','$pwd')
									...
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"method="post" action=<?php $_SERVER['PHP_SELF']?>>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="first-name" required="required" class="form-control " name="full">
											</div>
										</div>
										<div class="item form-group">

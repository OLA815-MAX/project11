...
if (isset($_POST['add'])) {
	...
	$act=$_POST['act'];
	$img=$_POST['image'];
	if(!empty($date)&&!empty($tit)&&!empty($con)&&!empty($auth)&&!empty($act)&&!empty($img))
{$sql="INSERT INtO news(news_date,title,content,author,status,image )VALUES('$date','$tit','$con','$auth','$act','$img')
						...
						<ul class=" navbar-right">
							<li class="nav-item dropdown open" style="padding-left: 15px;">
								<a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
									<img src="images/img.jpg" alt=""><?php echo "welcome".$_COOKIE['admin'];?>
								</a>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action=<?php $_SERVER['PHP_SELF']?>>
										...
										<div class="item form-group">
											...
											<div class="checkbox">
												<label>
													<input type="checkbox" class="flat" name="act">
												</label>
											</div>
										</div>
										<div class="item form-group">
